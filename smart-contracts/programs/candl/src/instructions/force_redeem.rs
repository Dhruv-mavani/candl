...
pub struct ForceRedeem<'info> {
    ...
    /// CHECK: not a signer on purpose -- this is the point of the
    ...
    #[account(mut, address = trader_position.trader)]
...
pub fn handler(ctx: Context<ForceRedeem>, shares: u64) -> Result<()> {
